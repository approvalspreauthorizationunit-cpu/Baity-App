...
## Database Tables
- regions
- users (RLS recursion fixed)
- seller_profiles (added is_verified, verified_at, verified_by)
- products
- orders
- order_items
- special_requests
...
| Date | Task | Status |
|------|------|--------|
| 2026-05-07 | Seller verification badge feature (blue checkmark #1D9BF0) | ✅ Done |
| 2026-05-07 | Database migration for is_verified, verified_at, verified_by | ✅ Done |
| 2026-05-07 | Admin can grant/revoke verification from seller details modal | ✅ Done |
| 2026-05-07 | Guest Mode enabled — browse products without login | ✅ Done |
| 2026-05-07 | Fixed infinite recursion in users RLS policy | ✅ Done |
| 2026-05-07 | Expanded test data seeding (Mansoura/Damietta, verified sellers, orders, ratings) | ✅ Done |
| 2026-05-07 | App published to Expo Go (channel: default) | ✅ Done |
...
- **Guest Mode**: Users can browse the marketplace and add items to cart as guests. Login is only mandatory at checkout.
...
- **Expo Go**: Permanent Classic link `exp://exp.host/@mostafa_15_93/baiti`.
...
- **Navigation Structure**: Introduced `GuestRoot` and `GuestTabs` to support unauthenticated browsing.
